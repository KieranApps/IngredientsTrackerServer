...
router.post('/remove/:id', checkAccessToken, asyncRequest(removeShoppingListItem)); // When removed from shopping list because bought, so add to stock
router.delete('/delete/:id', checkAccessToken, asyncRequest(deleteShoppingListItem)); // Deleted from list, not bought
